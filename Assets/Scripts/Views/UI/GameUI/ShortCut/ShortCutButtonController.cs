...
public class ShortCutButtonController:MonoBehaviour,IPointerEnterHandler,IPointerExitHandler,IDragHandler,IEndDragHandler,IBeginDragHandler
{
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        if (ItemInGame != null)
        {
           MesPlaneController.Instance.ShowItemMes(string.Format("<color=>"+ItemInGame.Name+"</color>"));
        }
    }
